        ...
        conf='''server
{
    ...
    def AddSite(self,get):
        ...
        get.path = self.__get_site_format_path(get.path).lower()
...
""" % (siteName,siteName);
                ...
                if not public.inArray(tmp,'443'):
                    ...
                    conf = conf.replace(listen,listen + "\n\tlisten 443 ssl"+http2 + listen_ipv6)
        ...
        if advanced == 1:
            if type == 1 and cache == 1:
                ng_proxy_cache += ng_proxy % (
                    get.proxydir, get.proxydir,get.todomain ,get.proxysite, get.proxysite, get.todomain, ng_sub_filter, ng_cache ,get.proxydir)
            if type == 1 and cache == 0:
                ng_proxy_cache += ng_proxy % (
                    get.proxydir, get.proxydir,get.todomain ,get.proxysite, get.proxysite, get.todomain, ng_sub_filter,'' ,get.proxydir)
        else:
            if type == 1 and cache == 1:
                ng_proxy_cache += ng_proxy % (
                    get.proxydir, get.proxydir,get.todomain ,get.proxysite, get.proxysite, get.todomain, ng_sub_filter, ng_cache, get.proxydir)
