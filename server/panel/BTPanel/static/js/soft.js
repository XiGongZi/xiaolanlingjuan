...
var soft = {
    get_list: function (page, type, search) {
        ...
        bt.soft.get_soft_list(page, type, search, function (rdata) {
            ...
            if (type == 10) {
                $("#updata_pro_info").html('<div class="alert alert-info" style="margin-bottom:15px"><strong>当前插件市场为邀请入驻，所有人都可以自行开发插件自己使用，详情可加入开发者专用群讨论。</strong><a class="btn btn-success btn-xs va0 updata_pro" href="https://www.bt.cn/bbs/forum-40-1.html" title="点击获取第三方应用" style="margin - left: 8px" target="_black">获取第三方应用</a>\
