...
<head>
<title>爱客影院后台管理登录 - Powered By www.woaik.com</title>
...
<tr class="header">
		...
		<tr>
		  ...
		  <td width="260" align="left" valign="middle"><input name="username" type="text" class="inp" id="username" value="" size="30" maxlength="32" autocomplete="off"><span class="gray tips"></span></td>
		</tr>
		<tr>
			<td valign="middle" align="right" class="tx" style="font-size:16px;">密　码：</td>
		  <td align="left" valign="middle"><input name="password" type="password" class="inp" id="password" value="" size="30" maxlength="64"><span class="gray tips"></span></td>
		</tr>
