...
class hunkiHelper
{
	...
	function getHtml($html)
	{
		...
		if (strpos($requestUrl, 'wap') or strstr($requestUrl, 'r=a/t') or strstr($requestUrl, 'index/classify') or strstr($requestUrl, 'index/r') or strstr($requestUrl, 'index/cat') or strstr($requestUrl, 'index/9') or strstr($requestUrl, 'r=index/lay') or strstr($requestUrl, 'r=every/e')) {
